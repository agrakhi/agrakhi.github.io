...
- David Collins (BU, joint with [X. Qiao](https://people.math.binghamton.edu/qiao/), 2023–present): *Subdata selection for high-dimensional and multivariate data*
- Bruce Phillips (BU, joint with [X. Qiao](https://people.math.binghamton.edu/qiao/), 2023–present): *Advanced topics in subdata selection*
